 ...
 *
 *  - Base10SerialNumberPartConfigConverter.kt (Last change: 2/24/23, 9:56 PM by shrralis)
 *
...
import com.shrralis.serialnumbergenerator.config.DEFAULT_BASE_10_PART_PATTERN
...
/**
 * A converter class for a base-10 generated serial number part configuration.
 *
 ...
 */
class Base10SerialNumberPartConfigConverter(
    rawFormatPartRegex: Regex = Regex(DEFAULT_BASE_10_PART_PATTERN),
    ...
    override fun convert(rawFormatPart: String): SerialNumberPartConfig =
        Base10SerialNumberPartConfig(extractPartWidth(rawFormatPart))
}
